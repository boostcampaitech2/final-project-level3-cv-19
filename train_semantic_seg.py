...
def main(args):
    ...
    # dataset
    train_dataset = CustomDataset(data_path=args.dataset_path, mode='train', app_mode='semantic', transform=train_transform)
    val_dataset = CustomDataset(data_path=args.dataset_path, mode='val', app_mode='semantic', transform=val_transform)
