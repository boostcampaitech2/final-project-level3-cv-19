...
from utils.Trainer2 import TorchTrainer
from utils.models import UnetResnet50
...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_dir', type=str, default='./saved/seg_class2.pt', help='saved_dir')
    parser.add_argument('--save_file_name', type=str, default='resnet50.pt', help='save_file_name')
    parser.add_argument('--num_epochs', type=int, default=15, help='num_epochs (default: 20)')
    parser.add_argument('--batch_size', type=int, default=64, help='batch size for training (default: 4)')
